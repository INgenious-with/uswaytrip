...
✨스프링 프로젝트에 들어와서 느꼈던 점은 Java에서부터 비롯되는 부족함을 도저히 메꿀 수 없었다는 점이었습니다.<br>
국비과정을 통하여 처음 웹개발을 접하였고, Java부터 HTML, CSS, JavaScript 등 모든 언어가 처음이었습니다.<br>
순식간에 3개월이라는 시간이 지나갔고, 담당한 기능을 구현하기에는 역량이 많이 부족했었습니다.<br>
하지만, 수업 내용 복습 등 부족한 부분을 채워나가면서 필요한 기술과 지식을 습득하였습니다.<br>
그 결과, 제가 맡은 기능에 대한 구현을 진행할 수 있었습니다.<br>
